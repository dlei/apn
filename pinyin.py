...
for k, v in PinYinDict.items():
	
	if len(v)<=1:

		newPinYinDict[ord(k.decode('utf-8'))] = (v[0].decode('utf-8'),)
		#newPinYinDict.add((ord(k.decode('utf-8')), v[0].decode('utf-8')))
	else:
		#generate tuple:
		new_v=tuple()
		for item in v:
			new_v = new_v + (item.decode('utf-8'),)

		newPinYinDict[ord(k.decode('utf-8'))] = new_v
